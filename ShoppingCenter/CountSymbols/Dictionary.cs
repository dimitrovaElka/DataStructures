...
public class Dictionary<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>
{
    ...
    public void Add(TKey key, TValue value)
    {
        ...
        foreach (var item in elements[index].Where(x => x != null))
        {
    ...
    private void Grow()
    {
        Dictionary<TKey, TValue> newTable =
            new Dictionary<TKey, TValue>(this.Capacity * 2);
        var notNullElements = this.elements.Where(x => x != null);
    ...
    public IEnumerable<TKey> Keys
    {
        ...
        {
            var notNullElements = this.elements.Where(x => x != null);
            return notNullElements.SelectMany(x => x).Select(y => y.Key);
        }
    }
    ...
    public IEnumerable<TValue> Values
    {
        get
        {
            ...
            foreach (var kvp in notNullElements)
            {
